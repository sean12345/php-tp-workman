...
// contentType: false,
// processData: false,
                    // fileElementId:['file_01'],
                    // uploadProgress: fileUpload,
                    // error: errorShow,
                });

                // $("#frm_requester").AjaxFileUpload({
                //     // beforeSend: clearResult,
                //     // beforeSubmit:  checkForm,  // pre-submit callback
                //     // success:       complete,  // post-submit callback
                //     // dataType: 'json',
        ...
        <div class="am-u-md-6">
          <div class="am-panel am-panel-default">
            ...
            <div class="am-panel-bd am-collapse am-in" id="collapse-panel-1">
                <form ENCTYPE="multipart/form-data"  class="am-form" id="frm_requester" name="frm_requester" method='post' action="<?php echo U('admin/fdebuger/frequest', '', '');?>">
...
<!--                     <div class="am-g am-margin-top-sm">
                    ...
                    <div class="am-g am-margin-top-sm">
                      ...
                      <div class="am-u-sm-4 am-u-end">
        　　　　<input id="file_01" name="file_01" type="file" >
                      </div>
                    </div>
