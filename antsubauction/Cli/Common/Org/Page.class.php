...
class Page{
    ...
    public function pageShow() {
        ...
        //下一页
        $down_row  = ($this->nowPage + 1) > $this->totalPages ? $this->totalPages : ($this->nowPage + 1);
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li class="active"><a href="javascript:void(0);">' . $page . '<span class="sr-only">(current)</span></a></li>';
                }
            }
        }
        //替换分页内容
