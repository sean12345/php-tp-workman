    ...
    <div class="admin-content-body">
      ...
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf">
            <strong class="am-text-primary am-text-lg">系统模块</strong> / <small>接口调试</small>
        </div>
      </div>
      <hr>
      <div class="am-g">
        <div class="am-u-md-6">
          <div class="am-panel am-panel-default">
            ...
            <div class="am-panel-bd am-collapse am-in" id="collapse-panel-1">
                <form class="am-form" id="frm_requester" name="frm_requester" method='post' action="/Admin/Debuger/request">
